  ...
  return (
    ...
    <DropDiv className='sortDrop'>
        ...
        <form>
            <div>
                ...
                <input type="radio" id="html"  name='xyz' value="Price Low to High" onChange={sortByPriceAsc}/>
            </div>
            <div>
                <label for="css">Price High to low</label><br/>
                <input type="radio" id="css" name='xyz' value="Price High to low" onChange={sortByPriceDesc}/>
            </div>
            <div>
                <label for="javascript">Name A to Z</label>
                <input type="radio" id="javascript" name='xyz' value="Name A to Z" onChange={sortByTitleAsc}/>
            </div>
            <div>
                <label for="javascript">Name Z to A</label>
                <input type="radio" id="javascript" name='xyz' value="Name A to Z" onChange={sortByTitleDesc}/>
            </div>
            <div>
                <label for="javascript">Material</label>
                <input type="radio" id="javascript" name='xyz' value="Name A to Z" />
            </div>
            <div>
    ...
    <DropDiv className='PriceDrop'>
        ...
        <DropDown className='Price' >
            <form>
            <div>
                <label for="html">₹ 0 - 499</label><br/>
                <input type="radio" id="html"  name='xyz' value="Price Low to High" />
            </div>
            <div>
                <label for="css">₹ 500 - 999</label><br/>
                <input type="radio" id="css" name='xyz' value="Price High to low" />
            </div>
            <div>
    ...
    <FiltrButton >Material</FiltrButton>
        ...
        <form>
            <div>
                <label for="html">Plastic</label><br/>
                <input type="radio" id="html"  name='xyz' value="Price Low to High" />
            </div>
            <div>
                <label for="css">Metal</label><br/>
                <input type="radio" id="css" name='xyz' value="Price High to low" />
            </div>
            <div>
    ...
    <DropDiv className='CategoryDrop'>
        ...
        <form>
            <div>
                ...
                <input type="radio" id="Furniture"  name='xyz' value="Furniture" onChange={byFurniture}/>
            </div>
            <div>
                <label for="Kitchen & appliances">Kitchen & appliances</label><br/>
                <input type="radio" id="css" name='xyz' value="Kitchen & appliances" onChange={byKitchen}/>
            </div>
            <div>
                <label for="Beds & mattresses">Beds & mattresses</label>
                <input type="radio" id="Beds & mattresses" name='xyz' value="Beds & mattresses" onChange={byBeds}/>
            </div>
            <div>
                <label for="Lighting">Lighting</label>
                <input type="radio" id="Lighting" name='xyz' value="Lighting" onChange={byLighting}/>
            </div>
            <div>
                <label for="Working from home">Working from home</label>
                <input type="radio" id="javascript" name='xyz' value="Working from home" onChange={byWorking}/>
            </div>
            <div>
                <label for="Textiles">Textiles</label>
                <input type="radio" id="Textiles" name='xyz' value="Textiles" onChange={byTextile}/>
            </div>
            <div>
                <label for="Decoration">Decoration</label>
                <input type="radio" id="Decoration" name='xyz' value="Decoration" onChange={byDecoration}/>
            </div>
            <div>
                <label for="Bathroom products">Bathroom products</label>
                <input type="radio" id="Bathroom products" name='xyz' value="Bathroom products" onChange={byBathroom}/>
            </div>
            <div>
                <label for="Outdoor products">Outdoor products</label>
                <input type="radio" id="Outdoor products" name='xyz' value="Outdoor products" onChange={byOutdoor}/>
            </div>
            <div>
                <label for="Baby & children">Baby & children</label>
                <input type="radio" id="Baby & children" name='xyz' value="Baby & children" onChange={byBaby}/>
            </div>
        </form>
        </DropDown>
    </DropDiv>
